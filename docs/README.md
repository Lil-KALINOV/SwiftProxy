...
- Windows 10+ x64 для `SwiftProxy_windows.exe`
- Windows 10+ ARM64 для `SwiftProxy_windows_arm64.exe`
- Windows 7 (x64) для `SwiftProxy_windows_7_64bit.exe`
- Windows 7 (x32) для `SwiftProxy_windows_7_32bit.exe`
- Intel macOS 10.15+
