...
4. **Добавьте домен в [zapret](https://github.com/LilKALINOV/zapret-discord-youtube/) или в любое другое ПО, так как подсеть Cloudflare может быть заблокирована (например, в России).**

5. В настройках `SwiftProxy` замените домен на свой.
